" xml.vim filetype plugin by Mads N Noe (www.mntnoe.com)
" Funcions ParseTag and TagMatch et al by Devin Weaver
" see http://www.vim.org/scripts/script.php?script_id=301
" Also thanks to http://www.pinkjuice.com/howto/vimxml/index.xml
...
command! -nargs=1 Validate call s:ValidateXMLSchema(<f-args>) 

let b:did_ftplugin = 1

if !exists("*s:ValidateXMLSchema")
function s:ValidateXMLSchema(xsdParam)
	execute "%w !xmllint --noout --schema " . a:xsdParam . " -"
endfunction
endif
